# Chapter 7 Seed Draft

Author's own starting material for the chapter 7 rewrite — outline, scene sketches,
specific beats or lines you want kept, worldbuilding details (e.g. the abyssal-plain
recovery mechanism, the deep-sea-miner crew), fragments of prose, whatever form is
useful to you. Doesn't need to be complete or polished.

This file is read alongside `direction-notes-chapter-7.md` and takes precedence on
concrete content — specific beats, images, or lines here should be built from and
preserved, not just used as inspiration. If something here conflicts with continuity
in chapters 1-6 or chapter 8, the rewrite will flag the conflict rather than silently
overriding either file.
